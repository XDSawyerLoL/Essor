  ...
  return (
    <main className="public-policy">
      ...
      <article>
        ...
        <section><h2>4. Présence anonyme</h2><p>Quand l’espace personnel est ouvert, ESSOR envoie un identifiant aléatoire distinct de celui du Cercle. Il est transformé en empreinte avant stockage et sert uniquement à compter les présences actives et celles des dernières 24 heures. Aucun prénom, avatar, parcours, bilan, journal ou position n’est associé à cette présence.</p><p>Une présence est considérée active pendant environ trois minutes. L’empreinte est automatiquement supprimée après 24 heures.</p></section>
        ...
        <section><h2>6. Suppression et contrôle</h2><p>Dans les réglages, « Tout effacer » supprime immédiatement les données locales ESSOR, y compris l’agenda, sans attendre une réponse du serveur. L’application envoie en parallèle une demande de suppression des signes du Cercle et de la présence anonyme. Sur Android, elle annule aussi les rappels natifs programmés. Cette action ne résilie pas un abonnement : la résiliation s’effectue dans le portail Stripe ou Google Play.</p><p>Si une demande serveur ne peut pas être remise au moment de l’effacement, la suppression locale reste effective ; les présences anonymes expirent automatiquement et les signes du Cercle restent soumis à leur durée de conservation maximale de 30 jours. Un signe peut aussi être retiré individuellement depuis le Cercle tant que l’identifiant local existe.</p></section>
